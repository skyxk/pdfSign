...
//    public static final String pfxPath = "/usr/esstempfile/demo.pfx";
    ...
    public static final String ftpIp = "10.41.0.66";
    public static final int ftpPort = 21;
    public static String ftpUser = "system001";
    public static String ftpPwd = "fwfs#652dQ31fsdJ*4d";
    private static String sysNum = "001";
